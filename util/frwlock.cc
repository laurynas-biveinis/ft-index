...
void frwlock::init(
 ...
 , const toku_instr_key &rwlock_instr_key
    ...
    #if defined(TOKU_PFS_EXTENDED_FRWLOCKH)
      toku_pthread_rwlock_init(rwlock_instr_key, &m_rwlock, NULL);                                                
    #endif
    
    #if defined(TOKU_PFS_EXTENDED_FRWLOCKH_INTERNAL)
...
#if defined(TOKU_PFS_EXTENDED_FRWLOCKH)
        /* Instrumentation end */
        toku_instr_rwlock_wrlock_wait_end(m_rwlock_instr, 0);
#endif
        return;
    }
...
#if defined(TOKU_PFS_EXTENDED_FRWLOCKH)
    /* Instrumentation end */
    toku_instr_rwlock_rdlock_wait_end(m_rwlock_instr, 0);
#endif
